...
namespace SGMG.Dtos.Request.PersonalTecnico
{
  public class PersonalTecnicoRequestDTO
  {
    ...
    [StringLength(20, MinimumLength = 2, ErrorMessage = "El apellido paterno debe tener entre 2 y 20 caracteres")]
    [RegularExpression(@"^[a-zA-ZáéíóúÁÉÍÓÚñÑ\s]+$", ErrorMessage = "El apellido paterno solo puede contener letras y espacios")]
    public string? ApellidoPaterno { get; set; }

    [StringLength(20, MinimumLength = 2, ErrorMessage = "El apellido materno debe tener entre 2 y 20 caracteres")]
    ...
    [StringLength(50, ErrorMessage = "El área de servicio no puede exceder 50 caracteres")]
